...
class WebCrawler(object):
    ...
    def web_crawler(self):
        # use with as for executor, it will call shutdown() to free
        # resource when all tasks being finished.
        with concurrent.futures.ThreadPoolExecutor(self.pool_size) as executor:
            while len(self.links_to_visit) > 0 and len(self.links_visited) < self.max_requests:
                ...
                # python3 future multi-threading
